...
def transform(df, *args, **kwargs):
    """
    Transformer block to process the loaded data and prepare dimensions and fact table.
    """
    ...
    # Create fact table
    fact_table = df.merge(passenger_count_dim, on='passenger_count', how='inner') \
                   .merge(trip_distance_dim, on='trip_distance', how='inner') \
                   .merge(rate_code_dim, on='RatecodeID', how='inner') \
                   .merge(pickup_location_dim, on=['pickup_longitude', 'pickup_latitude'], how='inner') \
                   .merge(dropoff_location_dim, on=['dropoff_longitude', 'dropoff_latitude'], how='inner') \
                   .merge(datetime_dim, on=['tpep_pickup_datetime', 'tpep_dropoff_datetime'], how='inner') \
                   .merge(payment_type_dim, on='payment_type', how='inner') \
